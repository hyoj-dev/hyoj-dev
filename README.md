...
Backend Developer focused on building reliable services with Java and Spring Boot.

## About Me

- Building backend services with Java, Spring Boot, and relational databases
- Interested in practical products powered by data and AI
- Enjoy improving service reliability, API design, and developer experience
...
| --- | --- | --- | --- | --- |
| [**StoryCraft**](https://github.com/hyoj-dev/storycraft-backend) | AI-powered English story learning service | Backend | Spring Boot, OpenAI, AWS | 2025.04 – 2025.10 |
